...
namespace MinhaDemoMvc
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                ////vai testar primeira rota
                ////nova rota criar outra
                //endpoints.MapControllerRoute(
                //    name: "modulos",
                //    pattern: "Gestao/{controller=Home}/{action=Index}/{id?}");


                ////vai testar Segunda rota
                //endpoints.MapControllerRoute(
                //    name: "categoria",
                //    pattern: "{controller=Home}/{action=Index}/{id}/{categoria?}");

                //vai testar ultima rota
                //rota padr�o sempre que for iniciar
                //Implementando na controller a rota, iniciar� por l�
                endpoints.MapControllerRoute(
                    name: "default",
